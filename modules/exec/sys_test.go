...
// 	err := srvc.StartPollingResultQueue()
...
// 	srvc := exec.NewExecSrvc()
// 	execUuid := uuid.New()
// 	err := srvc.Enqueue(context.Background(), execUuid, "a=int(input());b=int(input());print(a+b)", "python3.10", []exec.TestFile{
// 		{InContent: strPtr("1\n2\n"), AnsContent: strPtr("3\n")},
// 		{InContent: strPtr("3\n4\n"), AnsContent: strPtr("6\n")},
// 	}, exec.TestingParams{
// 		CpuMs:  1000,
...
// 	require.NoError(t, err)
// 	srvc.Close()
// 	require.Equal(t, eval.Stage, exec.StageFinished)
...
// 	hundredTestFiles := make([]exec.TestFile, 100)
// 	for i := 0; i < 100; i++ {
...
// 		srvc := exec.NewExecSrvc()
// 		execUuid := uuid.New()
// 		err := srvc.Enqueue(context.Background(), execUuid, "#include <iostream>\nint main() {int a,b;std::cin>>a>>b;std::cout<<a+b<<std::endl;}", "cpp17", hundredTestFiles, exec.TestingParams{
// 			CpuMs:  1000,
// 			MemKiB: 20024,
// 		})
// 		if err != nil {
...
// 		// Basic validation
// 		if eval.Stage != exec.StageFinished {
