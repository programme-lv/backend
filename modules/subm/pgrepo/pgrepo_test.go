...
func TestSubmRepo_List_MultipleEntries(t *testing.T) {
	...
	// List all entities
	listedEntities, err := repo.ListSubms(context.Background(), 3, 1, "", nil, []string{}, []string{}, []string{}, true)
...
func TestSubmRepo_List_NoEntries(t *testing.T) {
	...
	listedEntities, err := repo.ListSubms(context.Background(), 100, 0, "", nil, []string{}, []string{}, []string{}, true)
