...
func EncodeCreateSubmissionRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		p, ok := v.(*submissions.Submission)
		if !ok {
			return goahttp.ErrInvalidType("submissions", "createSubmission", "*submissions.Submission", v)
		}
...
// marshalSubmissionsEvaluationToEvaluationRequestBody builds a value of type
// *EvaluationRequestBody from a value of type *submissions.Evaluation.
func marshalSubmissionsEvaluationToEvaluationRequestBody(v *submissions.Evaluation) *EvaluationRequestBody {
	res := &EvaluationRequestBody{
		UUID:          v.UUID,
		Status:        v.Status,
...
// marshalSubmissionsProgrammingLangToProgrammingLangRequestBody builds a value
// of type *ProgrammingLangRequestBody from a value of type
// *submissions.ProgrammingLang.
func marshalSubmissionsProgrammingLangToProgrammingLangRequestBody(v *submissions.ProgrammingLang) *ProgrammingLangRequestBody {
	res := &ProgrammingLangRequestBody{
		ID:       v.ID,
		FullName: v.FullName,
		MonacoID: v.MonacoID,
	}
...
// marshalSubmissionsTaskToTaskRequestBody builds a value of type
// *TaskRequestBody from a value of type *submissions.Task.
func marshalSubmissionsTaskToTaskRequestBody(v *submissions.Task) *TaskRequestBody {
	res := &TaskRequestBody{
	...
	if v.DefaultMdStatement != nil {
		res.DefaultMdStatement = marshalSubmissionsMarkdownStatementToMarkdownStatementRequestBody(v.DefaultMdStatement)
	}
	if v.Examples != nil {
		res.Examples = make([]*ExampleRequestBody, len(v.Examples))
		for i, val := range v.Examples {
			res.Examples[i] = marshalSubmissionsExampleToExampleRequestBody(val)
		}
	}
	...
	if v.VisibleInputSubtasks != nil {
		res.VisibleInputSubtasks = make([]*StInputsRequestBody, len(v.VisibleInputSubtasks))
		for i, val := range v.VisibleInputSubtasks {
			res.VisibleInputSubtasks[i] = marshalSubmissionsStInputsToStInputsRequestBody(val)
		}
	}
...
// marshalSubmissionsMarkdownStatementToMarkdownStatementRequestBody builds a
// value of type *MarkdownStatementRequestBody from a value of type
// *submissions.MarkdownStatement.
func marshalSubmissionsMarkdownStatementToMarkdownStatementRequestBody(v *submissions.MarkdownStatement) *MarkdownStatementRequestBody {
	if v == nil {
		return nil
	}
	res := &MarkdownStatementRequestBody{
		Story:   v.Story,
		Input:   v.Input,
		Output:  v.Output,
		Notes:   v.Notes,
...
// marshalSubmissionsExampleToExampleRequestBody builds a value of type
// *ExampleRequestBody from a value of type *submissions.Example.
func marshalSubmissionsExampleToExampleRequestBody(v *submissions.Example) *ExampleRequestBody {
	if v == nil {
		return nil
	}
	res := &ExampleRequestBody{
		Input:  v.Input,
		Output: v.Output,
		MdNote: v.MdNote,
	}
...
// marshalSubmissionsStInputsToStInputsRequestBody builds a value of type
// *StInputsRequestBody from a value of type *submissions.StInputs.
func marshalSubmissionsStInputsToStInputsRequestBody(v *submissions.StInputs) *StInputsRequestBody {
	if v == nil {
		return nil
	}
	res := &StInputsRequestBody{
		Subtask: v.Subtask,
	}
	if v.Inputs != nil {
...
// marshalEvaluationRequestBodyToSubmissionsEvaluation builds a value of type
// *submissions.Evaluation from a value of type *EvaluationRequestBody.
func marshalEvaluationRequestBodyToSubmissionsEvaluation(v *EvaluationRequestBody) *submissions.Evaluation {
...
// marshalProgrammingLangRequestBodyToSubmissionsProgrammingLang builds a value
// of type *submissions.ProgrammingLang from a value of type
// *ProgrammingLangRequestBody.
func marshalProgrammingLangRequestBodyToSubmissionsProgrammingLang(v *ProgrammingLangRequestBody) *submissions.ProgrammingLang {
...
// marshalTaskRequestBodyToSubmissionsTask builds a value of type
// *submissions.Task from a value of type *TaskRequestBody.
func marshalTaskRequestBodyToSubmissionsTask(v *TaskRequestBody) *submissions.Task {
	...
	if v.DefaultMdStatement != nil {
		res.DefaultMdStatement = marshalMarkdownStatementRequestBodyToSubmissionsMarkdownStatement(v.DefaultMdStatement)
	}
	if v.Examples != nil {
		res.Examples = make([]*submissions.Example, len(v.Examples))
		for i, val := range v.Examples {
			res.Examples[i] = marshalExampleRequestBodyToSubmissionsExample(val)
		}
	}
	if v.OriginNotes != nil {
		res.OriginNotes = make(map[string]string, len(v.OriginNotes))
	...
	if v.VisibleInputSubtasks != nil {
		...
		for i, val := range v.VisibleInputSubtasks {
			res.VisibleInputSubtasks[i] = marshalStInputsRequestBodyToSubmissionsStInputs(val)
		}
	}
...
// marshalMarkdownStatementRequestBodyToSubmissionsMarkdownStatement builds a
// value of type *submissions.MarkdownStatement from a value of type
// *MarkdownStatementRequestBody.
func marshalMarkdownStatementRequestBodyToSubmissionsMarkdownStatement(v *MarkdownStatementRequestBody) *submissions.MarkdownStatement {
	if v == nil {
		return nil
	}
...
// marshalExampleRequestBodyToSubmissionsExample builds a value of type
// *submissions.Example from a value of type *ExampleRequestBody.
func marshalExampleRequestBodyToSubmissionsExample(v *ExampleRequestBody) *submissions.Example {
	if v == nil {
		return nil
	}
...
// marshalStInputsRequestBodyToSubmissionsStInputs builds a value of type
// *submissions.StInputs from a value of type *StInputsRequestBody.
func marshalStInputsRequestBodyToSubmissionsStInputs(v *StInputsRequestBody) *submissions.StInputs {
	if v == nil {
		return nil
	}
