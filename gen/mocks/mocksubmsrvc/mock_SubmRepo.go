...
// CountSubms provides a mock function with given fields: ctx, authorUuid, authorIds, taskIds, langIds
func (_m *MockSubmRepo) CountSubms(ctx context.Context, authorUuid *uuid.UUID, authorIds []string, taskIds []string, langIds []string) (int, error) {
	ret := _m.Called(ctx, authorUuid, authorIds, taskIds, langIds)
...
//   - taskIds []string
//   - langIds []string
func (_e *MockSubmRepo_Expecter) CountSubms(ctx interface{}, authorUuid interface{}, authorIds interface{}, taskIds interface{}, langIds interface{}) *MockSubmRepo_CountSubms_Call {
	return &MockSubmRepo_CountSubms_Call{Call: _e.mock.On("CountSubms", ctx, authorUuid, authorIds, taskIds, langIds)}
}

func (_c *MockSubmRepo_CountSubms_Call) Run(run func(ctx context.Context, authorUuid *uuid.UUID, authorIds []string, taskIds []string, langIds []string)) *MockSubmRepo_CountSubms_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockSubmRepo_CountSubms_Call) RunAndReturn(run func(context.Context, *uuid.UUID, []string, []string, []string) (int, error)) *MockSubmRepo_CountSubms_Call {
	_c.Call.Return(run)
	return _c
}
...
// ListSubms provides a mock function with given fields: ctx, limit, offset, search, authorUuid, authorIds, taskIds, langIds
func (_m *MockSubmRepo) ListSubms(ctx context.Context, limit int, offset int, search string, authorUuid *uuid.UUID, authorIds []string, taskIds []string, langIds []string) ([]domain.Subm, error) {
	ret := _m.Called(ctx, limit, offset, search, authorUuid, authorIds, taskIds, langIds)
	...
	var r0 []domain.Subm
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int, int, string, *uuid.UUID, []string, []string, []string) ([]domain.Subm, error)); ok {
		return rf(ctx, limit, offset, search, authorUuid, authorIds, taskIds, langIds)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int, int, string, *uuid.UUID, []string, []string, []string) []domain.Subm); ok {
		r0 = rf(ctx, limit, offset, search, authorUuid, authorIds, taskIds, langIds)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]domain.Subm)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, int, int, string, *uuid.UUID, []string, []string, []string) error); ok {
		r1 = rf(ctx, limit, offset, search, authorUuid, authorIds, taskIds, langIds)
	} else {
		r1 = ret.Error(1)
	}
...
//   - taskIds []string
//   - langIds []string
func (_e *MockSubmRepo_Expecter) ListSubms(ctx interface{}, limit interface{}, offset interface{}, search interface{}, authorUuid interface{}, authorIds interface{}, taskIds interface{}, langIds interface{}) *MockSubmRepo_ListSubms_Call {
	return &MockSubmRepo_ListSubms_Call{Call: _e.mock.On("ListSubms", ctx, limit, offset, search, authorUuid, authorIds, taskIds, langIds)}
}

func (_c *MockSubmRepo_ListSubms_Call) Run(run func(ctx context.Context, limit int, offset int, search string, authorUuid *uuid.UUID, authorIds []string, taskIds []string, langIds []string)) *MockSubmRepo_ListSubms_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int), args[2].(int), args[3].(string), args[4].(*uuid.UUID), args[5].([]string), args[6].([]string), args[7].([]string))
	})
	return _c
}
...
func (_c *MockSubmRepo_ListSubms_Call) RunAndReturn(run func(context.Context, int, int, string, *uuid.UUID, []string, []string, []string) ([]domain.Subm, error)) *MockSubmRepo_ListSubms_Call {
	_c.Call.Return(run)
	return _c
}
