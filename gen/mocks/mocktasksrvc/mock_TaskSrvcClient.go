...
func (_m *MockTaskSrvcClient) DeleteTask(ctx context.Context, shortId string) error {
...
type MockTaskSrvcClient_DeleteTask_Call struct {
	*mock.Call
}
...
func (_e *MockTaskSrvcClient_Expecter) DeleteTask(ctx interface{}, shortId interface{}) *MockTaskSrvcClient_DeleteTask_Call {
	return &MockTaskSrvcClient_DeleteTask_Call{Call: _e.mock.On("DeleteTask", ctx, shortId)}
}
...
func (_c *MockTaskSrvcClient_DeleteTask_Call) Return(_a0 error) *MockTaskSrvcClient_DeleteTask_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockTaskSrvcClient_DeleteTask_Call) RunAndReturn(run func(context.Context, string) error) *MockTaskSrvcClient_DeleteTask_Call {
	_c.Call.Return(run)
	return _c
}
