...
func (_m *MockTaskSrvcClient) DeleteIllustrationImg(ctx context.Context, taskId string) *srvcerror.Error {
	...
	if rf, ok := ret.Get(0).(func(context.Context, string) *srvcerror.Error); ok {
		r0 = rf(ctx, taskId)
	} else {
		if ret.Get(0) != nil {
...
func (_m *MockTaskSrvcClient) GetTask(ctx context.Context, shortId string) (srvc.Task, *srvcerror.Error) {
	...
	var r0 srvc.Task
	var r1 *srvcerror.Error
	if rf, ok := ret.Get(0).(func(context.Context, string) (srvc.Task, *srvcerror.Error)); ok {
...
func (_m *MockTaskSrvcClient) ListTaskPreviews(ctx context.Context) ([]srvc.TaskPreview, *srvcerror.Error) {
	...
	var r0 []srvc.TaskPreview
	var r1 *srvcerror.Error
	if rf, ok := ret.Get(0).(func(context.Context) ([]srvc.TaskPreview, *srvcerror.Error)); ok {
		return rf(ctx)
	}
	...
	if rf, ok := ret.Get(1).(func(context.Context) *srvcerror.Error); ok {
		r1 = rf(ctx)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*srvcerror.Error)
...
func (_m *MockTaskSrvcClient) UpdateStatementMd(ctx context.Context, taskId string, statement srvc.MarkdownStatement) *srvcerror.Error {
	...
	var r0 *srvcerror.Error
	if rf, ok := ret.Get(0).(func(context.Context, string, srvc.MarkdownStatement) *srvcerror.Error); ok {
