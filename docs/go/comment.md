...
Local copy of [Go Doc Comments](https://go.dev/doc/comment), converted from the [golang/website](https://github.com/golang/website) source on 2026-08-17.

Except as noted on go.dev, the original is licensed under [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0/).
...
The [go/doc](https://pkg.go.dev/go/doc) and [go/doc/comment](https://pkg.go.dev/go/doc/comment) packages
provide the ability to extract documentation from Go source code,
and a variety of tools make use of this functionality.
The [`go` `doc`](https://pkg.go.dev/cmd/go#hdr-Show_documentation_for_package_or_symbol)
...
For a package comment, that means the [first sentence](https://pkg.go.dev/go/doc/#Package.Synopsis)
...
For example, here is an abridged version of the package comment for [gofmt](https://pkg.go.dev/cmd/gofmt):
...
The standard formatter [gofmt](https://pkg.go.dev/cmd/gofmt) reformats doc comments
...
The [`go/ast.ParseDirective`](https://pkg.go.dev/go/ast#ParseDirective) function and its
