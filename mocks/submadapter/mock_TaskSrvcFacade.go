...
import (
	...
	tasksrvc "github.com/programme-lv/backend/tasksrvc"
)
...
func (_m *MockTaskSrvcFacade) GetTask(ctx context.Context, shortId string) (tasksrvc.Task, error) {
	...
	var r0 tasksrvc.Task
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (tasksrvc.Task, error)); ok {
		return rf(ctx, shortId)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) tasksrvc.Task); ok {
		r0 = rf(ctx, shortId)
	} else {
		r0 = ret.Get(0).(tasksrvc.Task)
	}
...
func (_c *MockTaskSrvcFacade_GetTask_Call) Return(_a0 tasksrvc.Task, _a1 error) *MockTaskSrvcFacade_GetTask_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockTaskSrvcFacade_GetTask_Call) RunAndReturn(run func(context.Context, string) (tasksrvc.Task, error)) *MockTaskSrvcFacade_GetTask_Call {
	_c.Call.Return(run)
	return _c
}
