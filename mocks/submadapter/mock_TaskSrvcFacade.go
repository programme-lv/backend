...
import (
	...
	taskdomain "github.com/programme-lv/backend/task/taskdomain"
)
...
func (_m *MockTaskSrvcFacade) GetTask(ctx context.Context, shortId string) (taskdomain.Task, error) {
	...
	var r0 taskdomain.Task
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (taskdomain.Task, error)); ok {
		return rf(ctx, shortId)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) taskdomain.Task); ok {
		r0 = rf(ctx, shortId)
	} else {
		r0 = ret.Get(0).(taskdomain.Task)
	}
...
func (_c *MockTaskSrvcFacade_GetTask_Call) Return(_a0 taskdomain.Task, _a1 error) *MockTaskSrvcFacade_GetTask_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockTaskSrvcFacade_GetTask_Call) RunAndReturn(run func(context.Context, string) (taskdomain.Task, error)) *MockTaskSrvcFacade_GetTask_Call {
	_c.Call.Return(run)
	return _c
}
